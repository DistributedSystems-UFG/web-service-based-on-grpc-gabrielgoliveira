...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmployeesSeniors = channel.unary_unary(
                '/employee_service.EmployeeService/GetEmployeesSeniors',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                )
        self.GetEmployeesTechLeaders = channel.unary_unary(
                '/employee_service.EmployeeService/GetEmployeesTechLeaders',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeDataList.FromString,
                )
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetEmployeesSeniors': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeesSeniors,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
            'GetEmployeesTechLeaders': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmployeesTechLeaders,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeDataList.SerializeToString,
            ),
...
class EmployeeService(object):
    ...
    @staticmethod
    def GetEmployeesSeniors(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/GetEmployeesSeniors',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def GetEmployeesTechLeaders(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/GetEmployeesTechLeaders',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.EmployeeDataList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateEmployeeName(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/UpdateEmployeeName',
